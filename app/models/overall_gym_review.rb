...
class OverallGymReview < ApplicationRecord
  ...
  def calculate_overall_score_rank
    ...
    overall_score_rank += 1 while overall_scores[overall_score_rank - 1] > overall_score
    overall_score_rank
  end
  ...
  def calculate_problems_quality_rank
    ...
    rank = 1
    rank += 1 while overall_problems_qualities[rank - 1] > problems_quality
    rank
  end
  ...
  def calculate_cost_par_fee_rank
    ...
    cost_par_fee_rank = 1
    cost_par_fee_rank += 1 while overall_cost_par_fees[cost_par_fee_rank - 1] > cost_par_fee
    cost_par_fee_rank
  end
  ...
  def calculate_comfortableness_rank
    ...
    comfortableness_rank += 1 while overall_comfortablenesses[comfortableness_rank - 1] > comfortableness
  ...
  def calculate_service_rank
    ...
    service_rank = 1
    service_rank += 1 while overall_servicies[service_rank - 1] > service
    service_rank
  end
end
