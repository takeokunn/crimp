class GymReviewsController < ApplicationController
  ...
  def calculate_gym_ranking
    ...
    Gym.find(params[:gym_id]).update(overall_score: @overall_score, problems_quality: @problems_quality, cost_par_fee: @cost_par_fee, comfortableness: @comfortableness, service: @service)
  end
end
